# Generated by Django 3.1.4 on 2021-01-28 14:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accountType', models.CharField(blank=True, choices=[('company', 'company'), ('ordinary', 'ordinary')], max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair', models.CharField(blank=True, choices=[('long', 'long'), ('middle', 'middle'), ('short', 'short')], max_length=6, null=True)),
                ...
                ('procedure', models.CharField(choices=[('yes', 'yes'), ('no', 'no')], max_length=3)),
