...
def upload_photo_path(instance, filename):
    ext = filename.split('.')[-1]
    return '/'.join(['photo', str(instance.companyPost.id) + str(instance.dogName) + str(".") + str(ext)])
...
class Profile(models.Model):
    ...
    accountType = models.CharField(max_length=8, choices=Type, blank=True, null=True)
...
class Dog_Data(models.Model):
    ...
    HAIR = (('long', 'long'), ('middle', 'middle'), ('short', 'short'))
    ...
    height = models.CharField(blank=True, null=True, max_length=3)
